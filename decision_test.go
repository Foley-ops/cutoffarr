...
func TestRunRadarrDecisionEngine_UnmonitoredMovies_ExcludedFromReportEntirely(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, inst, movies, map[int]bool{}, "cutoffarr-exclude", fullLibraryScope(slog.LevelInfo), true, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_MoviefileFetchedOnlyForMoviesPassingRulesOneThroughFive(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, inst, movies, wantedIDs, "cutoffarr-exclude", fullLibraryScope(slog.LevelInfo), true, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_WriteMode_UnmonitorsOnlyWouldUnmonitorItems(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", fullLibraryScope(slog.LevelInfo), false, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_EveryWouldUnmonitorDecisionIsAccountedForInTheSummary(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", fullLibraryScope(slog.LevelInfo), tc.dryRun, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_OnlyID_ReportsAndWritesOnlyTheTarget(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", onlyIDScope(2), false, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_OnlyID_CrossCheckStillRunsOnFullCandidatePools(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", onlyIDScope(2), true, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_OnlyID_UnknownId_WarnsAndMakesNoDecisions(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", onlyIDScope(4242), false, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_CrossCheckBlockedWithNothingToWrite_SaysSoPlainly(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{1: true}, "cutoffarr-exclude", fullLibraryScope(slog.LevelInfo), false, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_CrossCheckVerifiedNoWouldUnmonitorItem_WritePassBlocked(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{2: true}, "cutoffarr-exclude", fullLibraryScope(slog.LevelInfo), false, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_WebhookScope_CoalescedIDs_ReportsAndWritesEachOfThem(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", webhookScope([]int{3, 1}, nil), false, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_WebhookScope_DemotesPerItemLinesButNotTheSummary(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", webhookScope([]int{1}, nil), false, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_ScopedIDMissing_NamesItButStillProcessesTheRest(t *testing.T) {
	...
	runRadarrDecisionEngine(context.Background(), logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", webhookScope([]int{1, 4242}, nil), false, reverseOptions{}, fileReportOptions{})
...
func TestRunRadarrDecisionEngine_ShutdownMidEvaluation_AbandonsTheCycleWithoutWriting(t *testing.T) {
	...
	runRadarrDecisionEngine(ctx, logger, fake.instance(), movies, map[int]bool{}, "cutoffarr-exclude", fullLibraryScope(slog.LevelInfo), false, reverseOptions{}, fileReportOptions{})
